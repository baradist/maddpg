    ...
    def _set_action(self, action, agent, action_space, time=None):
        ...
        if agent.movable:
            ...
            if self.discrete_action_input:
                ...
                if action[0].argmax() == 1: agent.action.u[0] = -1.0
                if action[0].argmax() == 2: agent.action.u[0] = +1.0
                if action[0].argmax() == 3: agent.action.u[1] = -1.0
                if action[0].argmax() == 4: agent.action.u[1] = +1.0
            else:
        ...
        if not agent.silent:
            ...
            if self.discrete_action_input:
                ...
                agent.action.c[action[0].argmax()] = 1.0
            else:
